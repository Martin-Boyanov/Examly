...
const EXERCISES = {
  ...
  science: {
    ...
    physics: [
      ...
      { question: "What is gravity?", answer: "Force pulling objects to Earth" },
      { question: "What is the formula for speed?", answer: "distance/time" },
      { question: "What is the unit of energy?", answer: "Joule" },
      { question: "What is friction?", answer: "Force resisting motion" },
      { question: "What is inertia?", answer: "Resistance to change in motion" },
      { question: "What is acceleration?", answer: "Change in velocity" },
      { question: "What is mass?", answer: "Amount of matter" },
      { question: "What is a lever?", answer: "Simple machine" },
    ],
    chemistry: [
      { question: "What is H2O?", answer: "Water" },
      { question: "What is NaCl?", answer: "Salt" },
      { question: "What is the pH of pure water?", answer: "7" },
      { question: "What is a molecule?", answer: "Group of atoms" },
      { question: "What is the chemical symbol for gold?", answer: "Au" },
      { question: "What is a solution?", answer: "Mixture" },
      { question: "What is the formula for carbon dioxide?", answer: "CO2" },
      { question: "What is an acid?", answer: "pH less than 7" },
      { question: "What is a base?", answer: "pH greater than 7" },
      { question: "What is a compound?", answer: "Two or more elements" },
    ],
    biology: [
      { question: "What is the powerhouse of the cell?", answer: "Mitochondria" },
      { question: "What do plants use for photosynthesis?", answer: "Sunlight" },
      { question: "What is the largest organ in the human body?", answer: "Skin" },
      { question: "What is DNA?", answer: "Genetic material" },
      { question: "What is the basic unit of life?", answer: "Cell" },
      { question: "What do bees make?", answer: "Honey" },
      { question: "What is the process of breathing called?", answer: "Respiration" },
      { question: "What is the function of roots?", answer: "Absorb water" },
      { question: "What is the function of leaves?", answer: "Photosynthesis" },
      { question: "What is the function of the heart?", answer: "Pump blood" },
    ],
    earthscience: [
      ...
      { question: "What is a volcano?", answer: "Mountain with lava" },
      { question: "What is the water cycle?", answer: "Evaporation, condensation, precipitation" },
      { question: "What is a fossil?", answer: "Remains of ancient life" },
      { question: "What is the atmosphere?", answer: "Layer of gases" },
      { question: "What is a mineral?", answer: "Natural solid substance" },
      { question: "What is the core of the Earth?", answer: "Center" },
      { question: "What is a continent?", answer: "Large landmass" },
    ],
  },
};

// Utility to mark lesson as completed
async function markLessonCompleted(subject, lessonKey) {
  try {
    const raw = await AsyncStorage.getItem("completedLessons");
    const prev = raw ? JSON.parse(raw) : { math: ["1"], english: ["1"], science: ["1"] };
...
export default function LessonPage() {
  ...
  const exercises =
    EXERCISES[subject] && EXERCISES[subject][lessonKey]
      ? EXERCISES[subject][lessonKey]
      : [];
  ...
  const nextExercise = async () => {
    ...
    if (currentIdx < exercises.length - 1) {
      ...
      Animated.timing(animation, {
        ...
        await markLessonCompleted(subject, lessonKey); // <-- Save completion!
        setTimeout(() => {
          setShowFinishAnim(false);
          router.replace({
            pathname: "/",
            params: { subject, lesson: lessonKey, completed: "true" },
          });
        }, 1400);
      });
    }
    ...
    <View style={styles.container}>
      ...
      {!checked[currentIdx] ? (
        <Pressable
          style={[
            styles.checkBtn,
            !answers[currentIdx].trim() && { opacity: 0.5 },
          ]}
          onPress={checkAnswer}
        ...
        <Pressable style={styles.nextBtn} onPress={nextExercise}>
          <Text style={styles.nextBtnTxt}>Next Exercise</Text>
        </Pressable>
      ) : (
        <Pressable style={styles.finishBtn} onPress={nextExercise}>
